...
import { findProjectByKey, findProjectById, findAllProjects, insertProject, updateProject, type Project } from "@/services/projectService";
...
// Get project by Firestore document ID — used on edit page
